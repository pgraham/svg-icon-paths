 ...
 */
import pathBuilder from './builder.js'
...
const MIDDLE_RIGHT_LEG = LEG.copy().addSegment(
  'q',
  [-0.845, -0.845, -2.414, -1.239]
)

const MIDDLE_LEFT_LEG = MIDDLE_RIGHT_LEG.reverse().reflectY()

const BOTTOM_RIGHT_LEG = LEG.copy().addSegment(
  'q',
  [-0.845, -0.845, -2.933, -1.339]
)
...
const path = ['M10,2.75']
  .concat(HEAD.toList())
  .concat(['z m0,3.5', 'q4.7,0,4.5,1.5'])
  ...
  .concat(['q-0.93,1.016,-2.43,1.016', 'q-1.5,0,-2.43,-1.016'])
